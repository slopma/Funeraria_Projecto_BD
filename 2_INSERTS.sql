...
('SI', 'Muerte natural', '2023-06-16', 8, 3),
('NO', NULL, NULL, 9, NULL),
('SI', 'Causa desconocida', '2023-07-11', 10, 1),
('NO', NULL, NULL, 11, NULL),
('SI', NULL, NULL, 12, 2),
('SI', 'Drogas', '2022-12-03', 13, 3),
('NO', NULL, NULL, 14, NULL),
('NO', NULL, NULL, 15, NULL),
('SI', 'Ahogamiento', '2021-10-19', 16, 1),
('NO', NULL, NULL, 17, NULL),
('SI', NULL, NULL, 18, 2),
('SI', 'Fallecimiento repentino', '2023-03-26', 19, 1),
('NO', NULL, NULL, 20, NULL),
('SI', NULL, NULL, 21, 3),
('NO', 'Muerte súbita', '2022-11-06', 22, NULL),
('SI', NULL, NULL, 23, 2),
...
(1, 'Osario', 'NO', 'Sección D, Fila 4', '1.5x2 metros', 4),
(2, 'Tumba', 'SI', 'Sección A, Fila 5', '2.5x3 metros', 5),
(3, 'Osario', 'NO', 'Sección B, Fila 6', '2.5x3 metros', 6),
(1, 'Tumba', 'SI', 'Sección C, Fila 7', '1.5x2 metros', 7),
(2, 'Tumba', 'SI', 'Sección D, Fila 8', '2.5x3 metros', 8),
(3, 'Osario', 'NO', 'Sección A, Fila 9', '2.5x3 metros', 9),
(1, 'Osario', 'SI', 'Sección B, Fila 10', '1.5x2 metros', 10),
(2, 'Tumba', 'NO', 'Sección C, Fila 11', '2.5x3 metros', 11),
(3, 'Osario', 'SI', 'Sección D, Fila 12', '2.5x3 metros', 12),
(1, 'Tumba', 'SI', 'Sección A, Fila 13', '2.5x3 metros', 13),
(2, 'Osario', 'NO', 'Sección B, Fila 14', '1.5x2 metros', 14),
(3, 'Tumba', 'NO', 'Sección C, Fila 15', '2.5x3 metros', 15),
(1, 'Osario', 'SI', 'Sección D, Fila 16', '2.5x3 metros', 16),
(2, 'Tumba', 'NO', 'Sección A, Fila 17', '2.5x3 metros', 17),
(3, 'Tumba', 'SI', 'Sección B, Fila 18', '1.5x2 metros', 18),
(1, 'Osario', 'SI', 'Sección C, Fila 19', '2.5x3 metros', 19),
(2, 'Tumba', 'NO', 'Sección D, Fila 20', '2.5x3 metros', 20),
(3, 'Osario', 'SI', 'Sección A, Fila 21', '1.5x2 metros', 21),
(1, 'Osario', 'NO', 'Sección B, Fila 22', '2.5x3 metros', 22),
(2, 'Tumba', 'SI', 'Sección C, Fila 23', '2.5x3 metros', 23),
(3, 'Osario', 'NO', 'Sección D, Fila 24', '1.5x2 metros', 24),
...
('Cremación', NULL, NULL, NULL, 4, 1),
('Entierro', '2024-02-20 09:30:00', '2024-02-20', '2024-02-20 10:30:00', 5, 2),
('Cremacion', NULL, NULL, NULL, 6, 3),
('Cremación', NULL, NULL, NULL, 7, 1),
('Entierro', NULL, NULL, NULL, 8, 2),
('Cremación', '2024-05-10 11:00:00', '2024-05-10', '2024-05-10 13:00:00', 9, 3),
('Cremacion', '2024-04-25 10:30:00', '2024-04-25', '2024-04-25 12:00:00', 10, 1),
('Entierro', NULL, NULL, NULL, 11, 2),
('Cremacion', NULL, NULL, NULL, 12, 3),
('Entierro', '2023-11-20 15:00:00', '2023-11-20', '2023-11-20 16:30:00', 13, 1),
('Cremacion', '2023-10-05 09:00:00', '2023-10-05', '2023-10-05 11:00:00', 14, 2),
('Entierro', NULL, NULL, NULL, 15, 3),
('Cremacion', '2023-09-15 14:30:00', '2023-09-15', '2023-09-15 16:00:00', 16, 1),
('Entierro', NULL, NULL, NULL, 17, 2),
...
('Cremacion', NULL, NULL, NULL, 22, 1),
('Entierro', '2024-07-15 13:00:00', '2024-07-15', '2024-07-15 15:00:00', 23, 2),
('Cremacion', '2023-09-10 09:00:00', '2023-09-10', '2023-09-10 10:30:00', 24, 3),
('Entierro', NULL, NULL, NULL, 25, 1);
